...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1 AccTile*=256 / PeLanes=64 + multi-bank C.** Suite through `ai_gemm_s8_256x256_smoke`. Next: PeLanes 128+ / PE tree pipeline; I3 DRAM BW / wider NoC. |
