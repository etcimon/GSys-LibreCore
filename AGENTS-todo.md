...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1-lite AccTile=64 / PeLanes=16 + packed A/B/C AXI.** Cfg-bound; suite through `ai_gemm_s8_64x64_smoke`. Next: AccTile 128/256 toward SKU; measure DRAM BW (I3). |
