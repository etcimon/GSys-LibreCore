...
| **AI-P3** | T2 descriptor engine + SoC attach | P3 | **Spine + AXI + sideband + PLIC-8 + DMA R/W.** Fetch desc + **write completion word** at `ptr_done` (`ai_ptr_done_smoke`). Next: GEMM (I1). |
