...
| **AI-P3** | T2 descriptor engine + SoC attach | P3 | **Spine + AXI + sideband + PLIC-8.** DMA: `g6lc_ai_desc_fetch` RTL + xbar `NrSlaves=3` port reserved (idle). Next: wire fetch into island (desc_ptr MMIO / enq), GEMM (I1). |
