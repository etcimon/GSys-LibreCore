...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1 AccTile*=256 live / PeLanes=16 + multi-bank C.** Flat 65k C bank replaced by PeLanes banks of 4k i32; suite through `ai_gemm_s8_256x256_smoke`. Next: grow PeLanes / Macs; I3 DRAM BW measure. |
