...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1-lite AccTile=16 / PeLanes=8.** Cfg-bound gemm + cap window; directed through `ai_gemm_s8_16x16_smoke`. Next: continue scaling toward AccTile* 256 / SKU Macs; measure DRAM BW (I3). |
