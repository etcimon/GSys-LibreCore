...
| **AI-P3** | T2 descriptor engine + SoC attach | P3 | **Spine + AXI + sideband + PLIC-8 + DMA fetch.** Doorbell[31] or **ai.enq rs1≠0** fetches 64 B (`ai_desc_fetch_smoke`, `ai_enq_fetch_smoke`). Next: GEMM (I1), ptr_done writeback. |
