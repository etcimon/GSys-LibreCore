...
| **Soft ladder (DI OpenSBI residual scaffold)** | **P0 done** + **iter-012 / I4au soaked**. Hold + **natural `fdt_next_tag` cookie `51b1babe` dual-confirm** on `slfix` `28cd2aa9`. Post-cookie residual: no `51b1d000`/BANR, hart0 `ec14` illegal, hart1 `@2e8` `sp=0`. Soft getprop still in pin. | `ITERATION` I4au · `mk_plat_skip.py` · held/pin · `smt2-ai-tensor-linux.md` |
...
| **SL-A** | **iter-012 FDT + hold cookie** | P1–P2 | **Hold + natural `fdt_next_tag` cookie green** (I4au dual-confirm 2026-08-13 slfix `28cd2aa9`). Soft getprop still in pin. Post-cookie: no BANR / `ec14` / hart1 `sp=0`. PEEL getprop on `fw64` still `12eb2`. |
...
| **SL-B** | Peel soft getprop + real printf | P3–P4 | PEEL **cookie-exit** t=22528 (G1dd; `129f8` gone). Hold cookie **t=83968** + BANR. Soft getprop stays until `plat_hc==2` + `coldboot_done`. stash_keep_pc hygiene (`44c0f9bc`). hi8_npc_fetch MINI-FAIL G1ja/G1jd. lo11_npc00 MINI-FAIL sib P0 / FDT 0x10. lo_pc_npc00 HOLD-FAIL plat_hc=80. ljx0_off / ljx0_pc / ljx0_bp / lo_ld_lo11 / load_flush_next16 / leftover_off_npc00 hygiene (`e7b45ded`). leftover_slot0_off_npc00 MINI-FAIL sib 4 / lottery hang / FDT 17. load00_vs_off16 / leftover_nx8_npc00 hygiene (`6882ff4a`). leftover_hi8_s2 MINI-FAIL FDT 24 G1hu. load00_vs_lj / leftover_lo8_s2 hygiene (`55aa90c6`). load00_lo8_s2 hygiene (`2db4dea7`). sib_lo_s2 MINI-FAIL G1jp. lo_ld_stay HOLD-FAIL 51b1c001. hi8_lo11 MINI-FAIL FDT 57 G1jd. ld_until_01 MINI-FAIL FDT 106 G1lm. TRACE n7b8@20431 n7c0@20438. hangj 766 is bp_valid leftover jal. Not G1mg. Do not retire `mk_plat_skip` yet. |
