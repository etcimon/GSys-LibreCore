...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1-lite AccTile=16 / PeLanes=8 + beat-packed A/B load.** Multi-byte A unpack + B beat drain; suite through `ai_gemm_s8_16x16_smoke`. Next: scale AccTile*/Macs; measure DRAM BW (I3). |
