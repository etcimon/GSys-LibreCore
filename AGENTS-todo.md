...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1 AccTile*=256 / PeLanes=128; I3-lite multi-beat AR/AW + dual-bank C-read + B quad-drain + PMU→CAP.** Suite through `ai_gemm_s8_256x256_smoke`. Next: wider NoC (NocWidth>64); land ai-tensor host path. |
