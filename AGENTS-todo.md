...
| **AI-P3** | T2 descriptor engine + SoC attach | P3 | **Spine + AXI + sideband + PLIC-8 + DMA fetch.** `desc_ptr` + doorbell[31] loads 64 B from DRAM (`ai_desc_fetch_smoke`). Next: sideband-ptr fetch, GEMM (I1). |
