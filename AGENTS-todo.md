...
| **AI-S3** | Island RTL: cluster → memory → (latency SKU) → NoC/N clusters → PD | I1, I3, I2, I4 | **I1 AccTile*=256 / PeLanes=32 + multi-bank C.** Suite through `ai_gemm_s8_256x256_smoke`. Next: PeLanes 64+ toward SKU Macs; I3 DRAM BW / wider NoC. |
