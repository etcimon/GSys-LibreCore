...
| `soft-ladder-di` | directed (optional residual) | `soft-ladder-di-regress.sh` + `verif/tests/custom/multicore/mini_*.{S,c}` | Soft-ladder **P1**: bare DI B1 minis (AMO/LRSC/CSR/c.mv; FDT shape + **`mini_fdt_a0_is_fdt`** P0–P11 / P9e / P3 `0x2a`–`0x3a` / P4 `0x3b`–`0x3e` / isolated P4 / P6 `0x40`–`0x6a` / G1am `0x69` / G1as/G1at/G1ax/G1bb/G1bd HOLD-FAIL / G1au–G1bf keep; sibling class **`mini_sib_cjalr`** P0–P3 752/766/7ba / `CONTRACT.md`). Prefers `work-ver-smt2-slfix`. Map: `architecture/multi-threading/soft-ladder/README.md` · `COMPLETION.md` · `CONTRACT.md` |
