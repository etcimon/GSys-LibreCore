...
set_dont_touch i_cache_subsystem/i_g6lc_icache/gen_sram[*].data_sram
set_dont_touch i_cache_subsystem/i_g6lc_icache/gen_sram[*].tag_sram
...
set_input_delay -clock main_clk -max $input_delay i_cache_subsystem/i_g6lc_icache/gen_sram_*__data_sram/gen_cut_*__gen_mem_i_tc_sram_wrapper/rdata_o[*]
set_input_delay -clock main_clk -max $input_delay i_cache_subsystem/i_g6lc_icache/gen_sram_*__tag_sram/gen_cut_*__gen_mem_i_tc_sram_wrapper/rdata_o[*]
...
set_output_delay $output_delay -max -clock main_clk i_cache_subsystem/i_g6lc_icache/gen_sram_*__data_sram/gen_cut_*__gen_mem_i_tc_sram_wrapper/addr_i[*]
set_output_delay $output_delay -max -clock main_clk i_cache_subsystem/i_g6lc_icache/gen_sram_*__tag_sram/gen_cut_*__gen_mem_i_tc_sram_wrapper/addr_i[*]
...
report_timing -through i_cache_subsystem/i_g6lc_icache/gen_sram_*__data_sram/gen_cut_*__gen_mem_i_ram/rdata_o[*] >>  ${DCRM_FINAL_TIMING_REPORT}
report_timing -through i_cache_subsystem/i_g6lc_icache/gen_sram_*__tag_sram/gen_cut_*__gen_mem_i_ram/rdata_o[*] >>  ${DCRM_FINAL_TIMING_REPORT}
...
report_timing -through i_cache_subsystem/i_g6lc_icache/gen_sram_*__data_sram/addr_i[*] >>  ${DCRM_FINAL_TIMING_REPORT}
report_timing -through i_cache_subsystem/i_g6lc_icache/gen_sram_*__tag_sram/addr_i[*] >>  ${DCRM_FINAL_TIMING_REPORT}
