...
// Description:
// CVA6V-EC shim: ENUMVALUE fixes for default:'0 on enum fields (lines 757/871/949)
  ...
  always_comb begin: sequencer
      ...
      unique case (pe_req.vfu)
        ...
        VFU_MaskUnit: begin
          ...
          operand_request[AluA] = '{
            ...
            conv      : OpQueueConversionNone,
            cvt_resize: CVT_SAME,
            eew       : rvv_pkg::vew_e'('0), is_slide : 1'b0, is_reduct : 1'b0, vl : '0
          };
          // Since this request goes outside of the lane, we might need to request an
          // extra operand regardless of whether it is valid in this lane or not.
    ...
    if (vrgat_state_q == REQUESTING) begin
      ...
      operand_request[MaskB] = '{
        ...
        hazard     : '0,
        id : '0, is_slide : 1'b0, is_reduct : 1'b0, conv : OpQueueConversionNone, target_fu : target_fu_e'('0), vtype : '0
      };
