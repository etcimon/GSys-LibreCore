...
`endif
  ...
  if (FPUSupport != FPUSupportNone) begin : fpu_gen
    ...
    localparam fpu_features_t FPUFeatures = '{
      ...
      EnableVectors: 1'b1,
      EnableNanBox : 1'b1,
      FpFmtMask    : {RVVF(FPUSupport), RVVD(FPUSupport), RVVH(FPUSupport), RVVB(FPUSupport), RVVHA(FPUSupport)} /* CVA6 fpnew: 5 fmts */,
    ...
    localparam fpu_implementation_t FPUImplementation = '{
      ...
      UnitTypes: '{
        ...
        '{default: MERGED}}, // CONV  /* CVA6 fpnew: no DOTP opgroup */
