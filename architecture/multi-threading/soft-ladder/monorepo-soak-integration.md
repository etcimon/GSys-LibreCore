...
| **004** | `b1-amo-spin-lock` amo_buffer cancel kill + directed test | RTL landed `47572e98c`; OpenSBI peel pending re-soak |
| **005** | `b1-lrsc-cmpxchg` no-LR-flush + LR→SC store barrier | **in progress** (RTL in tree) |
