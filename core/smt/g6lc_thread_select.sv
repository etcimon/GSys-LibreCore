...
#(
  ...
  if (NH <= 1) begin : gen_single_hart
    ...
    always_comb begin
      ...
      unique case (POLICY)
        SMT_SWITCH_ON_MISS: begin
          if (active_stalled && found_clean) begin
            do_switch   = 1'b1;
            reason_miss = 1'b1;
    ...
    assign switch_o            = do_switch;
    assign switch_on_miss_o    = do_switch & reason_miss;
    assign switch_on_quantum_o = do_switch & reason_quantum;
    assign switch_on_starve_o  = do_switch & reason_starve;
