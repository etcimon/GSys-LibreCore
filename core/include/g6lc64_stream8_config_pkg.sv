...
// Stream8-class production package freeze (Etienne Cimon 2026)
// Residual bring-up envelope: NrCores=2, H+Sstc, Zacas W/D/Q, DeepSpec STQ,
// HPDCACHE_WT + L2, C-light in-order. See architecture/stream8-class.md.
// Derived from g6lc64_server_math (proven CRT 9/9). RVV=0 (use server_math_v).
...
// Modifications (c) 2026 Etienne Cimon: stream8 package derived from the Thales
// config package template via g6lc64_server_math.
