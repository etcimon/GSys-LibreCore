...
4. ~~AMOCAS.Q~~ **done** · ~~stream8 live RTL~~ **done** (Linux Verilator 5.008) · · dual-hart-ci residual soft lint/R3 skip when host-skewed · R3b Image (soft-skip gate) · dual-ISS · OpenSBI/Ara live still lab-optional.  
